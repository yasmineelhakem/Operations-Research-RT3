...
import numpy as np
N = 6  # Number of clients (including depot)
Q = 10  # Vehicle capacity
d = [0, 4, 6, 3, 5, 2]  # Demands of clients (index 0 is the depot)
D = np.array([[0, 10, 20, 15, 25, 30],  # Distance between clients D[i, j] matrix
              [10, 0, 35, 25, 20, 40],
              [20, 35, 0, 30, 15, 25],
              [15, 25, 30, 0, 10, 35],
              [25, 20, 15, 10, 0, 20],
